  ...
  render() {
    return (
      <div>
        ...
        <p>
          This is most useful for dealing with cases like <Code>apply</Code> where you want to pass an iterable as it{"'"}s components.
          In fact, apply is no longer needed to pass an array as arguments.
          <Playground codeText={b} es6Console={true} scope={{}} />
        </p>
        <p>
          Spread syntax works with any iterable, that includes arrays and instances of <Code>Map</Code> and <Code>Set</Code>.
